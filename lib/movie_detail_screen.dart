...
import 'package:movies_app/dummy.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<MoviesDetailsBloc>()
        ...
        ..add(GetMoviesRecommendedEvent(id: id)),
      ...
      builder: (context, state) {
        ...
        switch (state.moviesDetailsState) {
          ...
          case RequestState.error:
            return Center(child: Text(state.moviesDetailsMessage));
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8.0),
                          Text(
                            'Genres: ${_showGenres(movieDetails.geners)}',
                            style: const TextStyle(
                              color: Colors.white70,
                              fontSize: 12.0,
                              fontWeight: FontWeight.w500,
          ...
          case RequestState.loaded:
            return SliverGrid(
              delegate: SliverChildBuilderDelegate((context, index) {
                final recommendedMovies = state.recommendedMovies[index];
                ...
                return FadeInUp(
                  ...
                  child: ClipRRect(
                    ...
                    child: CachedNetworkImage(
                      imageUrl: AppConstance.imageUrl(
                        recommendedMovies.backdropPath!,
                      ),
